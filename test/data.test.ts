...
describe.skip('data', () => {
  it('Token', async () => {
    const token = await Fetcher.fetchTokenData(ChainId.MAINNET, '0xDA10009cBd5D07dd0CeCc66161FC93D7c9000da1') // DAI
  ...
  it('Pair', async () => {
    const token = new Token(ChainId.TESTNET, '0xDA10009cBd5D07dd0CeCc66161FC93D7c9000da1', 18) // DAI
