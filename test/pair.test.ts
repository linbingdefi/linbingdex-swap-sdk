...
describe('Pair', () => {
  const USDC = new Token(ChainId.MAINNET, '0x7F5c764cBc14f9669B88837ca1490cCa17c31607', 6, 'USDC', 'USD Coin')
  const DAI = new Token(ChainId.MAINNET, '0xDA10009cBd5D07dd0CeCc66161FC93D7c9000da1', 18, 'DAI', 'DAI Stablecoin')
